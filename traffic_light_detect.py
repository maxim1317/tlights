...
lower_red = np.array([0, 60, 80], dtype = "uint8")
upper_red = np.array([24, 255, 255], dtype = "uint8")

lower_violet = np.array([155, 60, 80], dtype = "uint8")
...
if __name__ == "__main__":
    ...
    mypath = '/home/oberon/vidz/'

    #берем все файлы с разрешением .avi и начинаем работу с ними
    file_list = [f for f in listdir(mypath) if isfile(join(mypath, f)) and f.split('.')[-1] == 'mp4']
